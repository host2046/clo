...
const Widgets = ({ articleResults, randomUserResult }) => {
  ...
  return (
    <div className="xl:w-[600px] ml-8 space-y-5 hidden lg:inline">
      ...
      <div className="bg-gray-100 pt-2 space-y-3 text-gray-500 rounded-xl w-[90%] xl:w-[75%]">
      ...
      <div className="sticky top-16 space-y-2  text-gray-700 bg-gray-100 w-[90%] xl:w-[75%] rounded-xl">
